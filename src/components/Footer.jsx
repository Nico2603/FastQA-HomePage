      ...
      <div className="footer-container">
        <div className="footer-top">
          <div className="footer-logo">
            <img src="/assets/logo.svg" alt="FastQA Logo" />
            <h3>FastQA</h3>
          </div>
          ...
          <div className="footer-links">
            ...
            <div className="footer-links-column">
              ...
              <ul>
                ...
                <li>
                  <a href="mailto:contacto@fastqa.com">
                    contacto@fastqa.com
                  </a>
                </li>
                <li>
        ...
        <div className="footer-tagline">
          <p>Construido con pasión por el testing automatizado y el desarrollo de software de calidad.</p>
        </div>
      </div>
    </footer>
  );
